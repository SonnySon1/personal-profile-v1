                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            <h5 class="card-subtitle"> Masukan Education / Pendidikan Kamu </h5>
                            <form class="form-horizontal mt-4" action="../../proses/prosesEducation/prosesTambahEducation.php" method="post" enctype="multipart/form-data">
