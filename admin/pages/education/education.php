...
$data = query("SELECT * FROM education");
?>
<!-- head -->
        ...
        <div class="page-wrapper">
            ...
            <div class="col-12">
                        <div class="card">
                            ...
                            <h3 style="position:absolute; right:0px; margin-top:0px; margin-right:10px;"><a href="tambahEducation.php" style="color: black;">+</a></h3>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-success" href="detailEducation.php?iesaxd=<?= $dat['id_education']; ?>">Detail</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-secondary" href="editEducation.php?iesaxd=<?= $dat['id_education']; ?>">Edit</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus education ini?');" href="../../proses/prosesEducation/prosesHapusEducation.php?iesaxd=<?= $dat['id_education']; ?>">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php endforeach; ?>
