                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            <h5 class="card-subtitle"> Masukan Experience / pengalaman dirimu </h5>
                            <form class="form-horizontal mt-4" action="../../proses/prosesExperience/prosesTambahExperience.php" method="post" enctype="multipart/form-data">
