                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            <h5 class="card-subtitle">Tambah Skill /  Kemampuan Kamu </h5>
                            <form class="form-horizontal mt-4" action="../../proses/prosesSkill/prosesTambahSkill.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Persen</label>
                                    <input name="persen" type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Foto</label><br>
