        ...
        <div class="page-wrapper">
            ...
            <div class="col-12">
                        <div class="card">
                            ...
                            <h3 style="position:absolute; right:0px; margin-top:0px; margin-right:10px;"><a href="tambahSkill.php" style="color: black;">+</a></h3>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?= $dat['persen']; ?></td>
                                            <td>
                                                <a class="btn btn-sm btn-secondary" href="editSkill.php?iesaxd=<?= $dat['id_skill']; ?>">Edit</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus skill ini?');" href="../../proses/prosesSkill/prosesHapusSkill.php?iesaxd=<?= $dat['id_skill']; ?>">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php endforeach; ?>
