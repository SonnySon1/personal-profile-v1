        ...
        <div class="page-wrapper">
            ...
            <div class="col-12">
                        <div class="card">
                            ...
                            <h3 style="position:absolute; right:0px; margin-top:0px; margin-right:10px;"><a href="tambahHobby.php" style="color: black;">+</a></h3>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-secondary" href="editHobby.php?iesaxd=<?= $dat['id_hobby']; ?>">Edit</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-danger" onclick="return dell('Yakin ingin menghapus hobby ini?');" href="../../proses/prosesHobby/prosesHapusHobby.php?iesaxd=<?= $dat['id_hobby']; ?>">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php endforeach; ?>
