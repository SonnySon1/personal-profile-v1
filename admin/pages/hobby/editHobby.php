...
// Lakukan sebuah query untuk menampilkan data berdasarjab ud
    $dat = query("SELECT * FROM hobby WHERE id_hobby = '$id_hobby'")[0];
?>
<!-- head -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            <h5 class="card-subtitle"> Edit Hobby /  Kegiatan yang Kamu Sukai Dengan Senang Hati </h5>
                            <form class="form-horizontal mt-4" action="../../proses/prosesHobby/prosesEditHobby.php" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="iesaxd" value="<?=  $dat['id_hobby'] ?>">
                                <input type="hidden" name="imageL" value="<?=  $dat['foto'] ?>">
                                <div class="form-group">
                                    <label>Hobby</label>
                                    <input name="hobby" type="text" class="form-control" value="<?= $dat['hobby'] ?>" >
                                </div>
                                <div class="form-group">
