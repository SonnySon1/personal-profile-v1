                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            <h5 class="card-subtitle"> Masukan Cv</h5>
                            <form class="form-horizontal mt-4" action="../../proses/prosesCv/prosesTambahCv.php" method="post" enctype="multipart/form-data">                                <div class="form-group">
                               <div class="form-group">
                                    <label>Cv Link</label>
                                    <textarea name="link_cv" class="form-control" rows="5"></textarea>
                                </div>
                                <div>
