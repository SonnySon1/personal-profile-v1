        ...
        <div class="page-wrapper">
            ...
            <div class="col-12">
                        <div class="card">
                            ...
                            <h3 style="position:absolute; right:0px; margin-top:0px; margin-right:10px;"><a href="tambahAbout.php" style="color: black;">+</a></h3>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus About ini?');" href="../../proses/prosesAbout/prosesHapusAbout.php?iesaxd=<?= $dat['id_about']; ?>">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php endforeach; ?>
